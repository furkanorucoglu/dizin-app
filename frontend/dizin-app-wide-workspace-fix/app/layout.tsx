...
export default function RootLayout({
  ...
  return (
    <html lang="tr">
      <body>
        <Providers>
          <div className="relative min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.16),transparent_34%),radial-gradient(circle_at_top_right,rgba(168,85,247,0.12),transparent_30%),linear-gradient(180deg,#f8fafc_0%,#eef2ff_100%)]">
            <div
              aria-hidden="true"
            ...
            <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-white/[0.78] backdrop-blur-2xl supports-[backdrop-filter]:bg-white/[0.62]">
              <div className="mx-auto flex h-16 w-full max-w-[min(1800px,calc(100vw-48px))] items-center justify-between px-3 sm:px-4 lg:px-6">
            ...
            <main className="mx-auto flex w-full max-w-[min(1800px,calc(100vw-48px))] flex-1 flex-col px-3 py-6 sm:px-4 lg:px-6">
              {children}
            </main>
          </div>
        </Providers>
